  ...
  <Container padded>
    <form onSubmit={handleSubmit} className="form">
      <label htmlFor="reward-name" className="form-control">
        ...
        <Field component={Input} name="name" placeholder="E.g. StarBucks" />
      </label>
      <label htmlFor="reward-title" className="form-control">
        <span>Title</span>
        <Field component={Input} name="title" placeholder="E.g. 10.000 VND off on total bill" />
      </label>
      <label htmlFor="brand_logo" className="form-control">
        <span>Logo Url</span>
        <Field component={Input} name="brand_logo" placeholder="Insert logo image url" />
      </label>
      <label htmlFor="reward-description" className="form-control">
        <span>Description</span>
        <Field component={TextArea} name="description" placeholder="Insert text here..." />
      </label>
